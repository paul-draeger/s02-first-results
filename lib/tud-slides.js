...
window.TUD = (function () {
  ...
  function init(userOptions) {
    ...
    /* Erst nach dem Start: die Hilfe (?) liest die Belegungen aus reveal, und
       vorher gibt es keine, in die sie eingetragen werden koennte. */
    return Reveal.initialize(revealConfig()).then(function (deck) {
      Reveal.addKeyBinding(
        { keyCode: 86, key: 'V', description: say('videoToggle') }, toggleVideos);
      return deck;
    });
  }
